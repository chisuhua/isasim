 ...
 * S2.u=carry-in). */
void InstructionVOP3B::V_ADDC_U32(WarpState *item, uint32_t lane_id)
{
	Register s0;
	Register s1;
	Register sum;
 ...
 */
/*
void InstructionVOP3B::V_DIV_SCALE_F64(WarpState *item, uint32_t lane_id)
{
